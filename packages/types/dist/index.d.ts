export type UserRole = 'ADMIN' | 'FACILITY_MANAGER' | 'LOGISTICS_OPERATOR' | 'VIEWER' | 'SIMULATOR';
...
export type BatchStatus = 'AVAILABLE' | 'LOW_STOCK' | 'EXPIRING_90' | 'EXPIRING_60' | 'EXPIRING_30' | 'EXPIRED' | 'SPOILED';
...
export type NotificationProvider = 'FAST2SMS' | 'TWILIO';
